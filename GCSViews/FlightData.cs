...
namespace MissionPlanner.GCSViews
{
    public partial class FlightData : MyUserControl, IActivate, IDeactivate
    {
        ...
        private void quickView_DoubleClick(object sender, EventArgs e)
        {
            ...
            // Define your whitelist of field names here    
            List<string> fieldWhitelist = new List<string>()
            {
                "roll",
                "pitch",
                "alt",
            ...
            // Iterate over the whitelist instead of all properties  
            foreach (var fieldName in fieldWhitelist)
            {
                var field = test.GetProperty(fieldName);
                if (field == null)
                    continue;
