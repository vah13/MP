...
namespace MissionPlanner
{
    public partial class MainV2 : Form
    {
        ...
        public MainV2()
        {
            ...
            {
                // Convert stream into an Image object
                Image decodedImage = Image.FromStream(ms);
                // Create a scaled Bitmap if you still want to maintain the 200×31 size
                var resizedImage = new Bitmap(decodedImage, new Size(170, 31));
                MenuArduPilot.Image = resizedImage;
            }
        ...
        private void MenuArduPilot_Click(object sender, EventArgs e)
        {
            try
            {
                System.Diagnostics.Process.Start("https://airworker.aero/");
            }
            catch
            {
                CustomMessageBox.Show("Failed to open url https://airworker.aero/");
            }
        }
